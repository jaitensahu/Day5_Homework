...
function App() {
  ...
  function getdata(inputvalueFromInputJs){
    setVal(inputvalueFromInputJs);
    if(inputvalueFromInputJs==0){
      alert("Enter a value")
    }
  }
  return (
    <div className="App">
    <Input getInputValue={getdata}/>
    <div className="paragraphContainer">
      {
        paragraphs.map((singlePara,idx)=>{
